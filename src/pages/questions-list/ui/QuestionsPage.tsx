...
export const QuestionsPage = () => {
  ...
  const { data, isLoading, isFetching, isError, error } = useGetQuestionsQuery(apiParams)
    ...
    <div className="questions-page">
      ...
      <aside className="questions-page__filters">
        ...
        <SpecializationFilter
          ...
          onChange={(specializationId) => updateFilters({ specializationId })}
        />
        ...
        <SkillsFilter
          ...
          onChange={(skillIds) => updateFilters({ skillIds })}
        />
      </aside>
      ...
      <main className="questions-page__content">
        ...
        <header className="questions-page__header">
          <h1>Вопросы</h1>
          <p className="questions-page__count">
        ...
        {isFetching && !isLoading && (
          <div className="questions-page__fetching">
            Обновление...
          </div>
        )}
